...
public class CodonCount {
    ...
    public void tester() {
        ...
        System.out.println("Counts of codons between 1 and 20 inclusive are: ");
        ...
        System.out.println("Most common codon is " + mostCommon2 + " with count " + codonCount.get(mostCommon2));
        ...
        String mostCommon3 = getMostCommonCodon();
        System.out.println("Most common codon is " + mostCommon3 + " with count " + codonCount.get(mostCommon3));
        System.out.println("Counts of codons between 1 and 5 inclusive are: ");
        printCodonCounts(1, 20);
